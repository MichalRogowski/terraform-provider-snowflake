...
func (r *CreateExternalAccessIntegrationRequest) toOpts() *CreateExternalAccessIntegrationOptions {
	...
	if r.AllowedApiAuthenticationIntegrations != nil {
		opts.AllowedApiAuthenticationIntegrations = &ExternalAccessIntegrationAllowedApiAuthenticationIntegrations{
			NoIntegrations: r.AllowedApiAuthenticationIntegrations.NoIntegrations,
			AllowedList:    r.AllowedApiAuthenticationIntegrations.AllowedList,
		}
	}
	if r.AllowedAuthenticationSecrets != nil {
		opts.AllowedAuthenticationSecrets = &ExternalAccessIntegrationAllowedAuthenticationSecrets{
			AllSecrets:  r.AllowedAuthenticationSecrets.AllSecrets,
			NoSecrets:   r.AllowedAuthenticationSecrets.NoSecrets,
			AllowedList: r.AllowedAuthenticationSecrets.AllowedList,
		}
	}
	return opts
}
	...
	if r.Set != nil {
		...
		if r.Set.AllowedApiAuthenticationIntegrations != nil {
			opts.Set.AllowedApiAuthenticationIntegrations = &ExternalAccessIntegrationAllowedApiAuthenticationIntegrations{
				NoIntegrations: r.Set.AllowedApiAuthenticationIntegrations.NoIntegrations,
				AllowedList:    r.Set.AllowedApiAuthenticationIntegrations.AllowedList,
			}
		}
		if r.Set.AllowedAuthenticationSecrets != nil {
			opts.Set.AllowedAuthenticationSecrets = &ExternalAccessIntegrationAllowedAuthenticationSecrets{
				AllSecrets:  r.Set.AllowedAuthenticationSecrets.AllSecrets,
				NoSecrets:   r.Set.AllowedAuthenticationSecrets.NoSecrets,
				AllowedList: r.Set.AllowedAuthenticationSecrets.AllowedList,
			}
		}
	}
	if r.Unset != nil {
